        ...
        >
            ...
            >
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-bold text-gray-800">📊 데이터 랩</h3>
                ...
                <div className="space-y-6">
                    {/* Gender Balance */}
                    <div>
                        <h4 className="text-sm text-gray-500 font-bold mb-3">성별 행복도 격차</h4>
                        <div className="flex gap-4">
                            <Card className="flex-1 bg-blue-50 border-blue-100 p-4 flex flex-col items-center">
                                <span className="text-2xl mb-1">👨</span>
                                <span className="text-sm text-gray-500">남자</span>
                            ...
                            <Card className="flex-1 bg-pink-50 border-pink-100 p-4 flex flex-col items-center">
                                <span className="text-2xl mb-1">👩</span>
                                <span className="text-sm text-gray-500">여자</span>
